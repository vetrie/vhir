        ...
        "rest": [
            {
                ...
                "resource": [
                    ...
                    # M1
                    _cap_resource("Group",                     ["read", "create", "update", "delete", "search"]),
                    _cap_resource("Location",                  ["read", "create", "update", "delete", "search"]),
                    _cap_resource("Device",                    ["read", "create", "update", "delete", "search"]),
                    _cap_resource("DeviceMetric",              ["read", "create", "update", "delete", "search"]),
                    _cap_resource("Procedure",                 ["read", "create", "update", "delete", "search"]),
                    _cap_resource("Immunization",              ["read", "create", "update", "delete", "search"]),
                    _cap_resource("MedicationDispense",        ["read", "create", "update", "delete", "search"]),
                    _cap_resource("MedicationAdministration",  ["read", "create", "update", "delete", "search"]),
